    ...
    <>
      <div>
        <div className="flex items-center justify-between pt-4 w-full mb-4">
          <h2 className="text-2xl font-semibold">{t("eventDetail.media.gallery")}</h2>
          {handleMediaUpload && allowEdit && (
            <>
              ...
              >
                ...
                <span className="hidden md:block">{t("eventDetail.media.addMedia")}</span>
              </Button>
            </>
          )}
        </div>
      ...
      {mediaFiles && mediaFiles.length > 0 ? (
        ...
        <Alert className="bg-blue-50 border-blue-200 text-blue-800 dark:bg-blue-900/50 dark:border-blue-700 dark:text-blue-300">
          ...
          <AlertDescription>
            {t("eventDetail.media.noMediaPresented")}
          </AlertDescription>
        </Alert>
      )}
    </>
