...
const mockEvents = [
  {
    ...
    description:
      "Join us for an electrifying night of salsa dancing with live music and professional instructors. Perfect for all skill levels!",
    date: "2024-12-15",
    time: "8:00 PM",
  ...
  },
  {
    ...
    description:
      "Intensive weekend workshop focusing on Argentine Tango fundamentals and advanced techniques with internationally renowned instructors.",
    date: "2024-12-20",
    time: "2:00 PM",
  ...
  },
  {
    ...
    description:
      "Come dance to the hottest bachata hits in a friendly, welcoming environment. Beginner lesson included before social dancing.",
    date: "2024-12-22",
    time: "7:30 PM",
  ...
  },
  {
    ...
    description:
      "Annual swing dance competition featuring Lindy Hop, Charleston, and Balboa divisions. Prizes for all levels and live swing band!",
    date: "2024-12-28",
    time: "6:00 PM",
  ...
  },
  {
    ...
    description:
      "Explore the sensual world of Kizomba and its modern evolution Urban Kiz. Learn connection, musicality, and signature moves.",
    date: "2025-01-05",
    time: "3:00 PM",
    location: "Motion Dance Studio, 321 Rhythm St",
    image:
      "https://goandance-media-cache-prod.s3.eu-central-1.amazonaws.com/poster_full/event/poster/2025/01/17/68067ac6401d7564059185.jpg",
    price: "$40",
    attendees: 24,
    maxAttendees: 30,
    difficulty: "Intermediate",
