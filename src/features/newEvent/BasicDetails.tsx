...
interface BasicDetailsProps extends Partial<StepComponentProps> {
    ...
    <div className={`p-4 md:p-6 ${className}`}>
      ...
      >
                ...
                <form.Field
                  ...
                  validators={{
                    onChange: ({ value }) => {
                      ...
                      if (!value) return "End date is required for recurring events";
        ...
        <div className="space-y-4">
          ...
          <div className={`grid ${showExactPrice ? 'grid-cols-1 md:grid-cols-2 gap-4' : 'grid-cols-1'}`}>
